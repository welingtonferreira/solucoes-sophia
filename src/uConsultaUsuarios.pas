...
type
  TfrmConsultaUsuarios = class(TForm)
    ...
    qryConsUsuariosNOME: TStringField;
    qryConsUsuariosCPF: TStringField;
    qryConsUsuariosRG: TStringField;
    qryConsUsuariosEMAIL: TStringField;
    qryConsUsuariosCEL: TStringField;
    qryConsUsuariosTEL: TStringField;
    qryConsUsuariosLOGIN: TStringField;
    qryConsUsuariosSENHA: TStringField;
