object frmControleAcesso: TfrmControleAcesso
  ...
  object Panel1: TPanel
    ...
    object trvPermissao: TTreeView
      ...
      Indent = 19
      TabOrder = 0
      OnClick = trvPermissaoClick
      OnEnter = trvPermissaoEnter
      OnExit = trvPermissaoExit
      OnKeyDown = trvPermissaoKeyDown
      ExplicitWidth = 696
      ExplicitHeight = 435
    end
    object GroupBox1: TGroupBox
      ...
      object gpbCliente: TGroupBox
        ...
        Width = 607
        Height = 44
        Caption = 'Usu'#225'rio ( F9 Consulta Usu'#225'rios )'
        TabOrder = 0
        object btnConsUsuario: TSpeedButton
          Left = 435
          Top = 15
          Width = 31
          Height = 26
