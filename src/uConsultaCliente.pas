...
type
  TfrmConsultaCliente = class(TForm)
    ...
    qryConsClienteNOME_COMPLETO: TStringField;
    qryConsClienteCPF_CNPJ: TStringField;
    qryConsClienteTELEFONE: TStringField;
    qryConsClienteEMAIL: TStringField;
    qryConsClienteENDERECO_COMPLETO: TStringField;
